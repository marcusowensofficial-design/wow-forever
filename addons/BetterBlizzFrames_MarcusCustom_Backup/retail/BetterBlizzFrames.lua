...
local defaultSettings = {
    ...
    -- Marcus Custom Options
    marcusPlayerHealthText = "Both",
    marcusPlayerResourceText = "Both",
    marcusTargetHealthText = "Both",
    marcusTargetResourceText = "Both",
    marcusTextFontSize = 11,
    marcusResourceFontSize = 10,
    marcusTextFont = "PT Sans Narrow Bold",
    marcusPlayerColorMode = "Class Color",
    marcusPlayerCustomColor = {0.10, 0.85, 0.10, 1},
    marcusTargetColorMode = "Dark Green",
    marcusTargetCustomColor = {0.85, 0.10, 0.10, 1},

    -- Marcus Buffs Below Player Frame
    marcusBuffsBelowPlayer = true,
    marcusDebuffsBelowBuffs = true,
    marcusBuffsXOffset = -14,
    marcusBuffsYOffset = -3,
    marcusBuffsScale = 0.90,
    marcusBuffsPerRow = 8,
    marcusBuffsHideCollapse = true,
    marcusBuffsHideDuration = false,

    -- Marcus Target Buffs Positioning
    marcusTargetBuffsXOffset = 1,
    marcusTargetBuffsYOffset = -1,
    marcusTargetBuffsScale = 1.0,
    marcusTargetBuffsPerRow = 8,
    marcusTargetBuffsSquare = true,
    marcusTargetBuffsHideDuration = false,

    -- Marcus Frame & Resource Bar Dimensions
    marcusPlayerHealthWidth = 123,
    marcusPlayerHealthHeight = 18,
    marcusPlayerResourceWidth = 123,
    marcusPlayerResourceHeight = 10,
    marcusPlayerFrameScale = 1.0,

    marcusTargetHealthWidth = 124,
    marcusTargetHealthHeight = 19,
    marcusTargetResourceWidth = 135,
    marcusTargetResourceHeight = 14,
    marcusTargetFrameScale = 1.0,
...
Frame:SetScript("OnEvent", function(...)
    ...
    local function LoginVariablesLoaded()
        if BBF.variablesLoaded then
            ...
            if BBF.InitializeMarcusCustomOptions then
                BBF.InitializeMarcusCustomOptions()
            end
